...
button.addEventListener("click", () => {
    ...
    input.innerText = "Create new note...";
    img.src = "https://i.postimg.cc/xjghQcns/icons8-delete.gif";
    img.className = "delete-icon";
    

    let noteWrapper = document.createElement("div");
    noteWrapper.className = "note-wrapper"; // Add a class for styling the note wrapper
    // notesContainer.appendChild(input).appendChild(img);
    noteWrapper.appendChild(input).appendChild(img);
